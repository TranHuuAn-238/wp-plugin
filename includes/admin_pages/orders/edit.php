                        ...
                        <div class="inside">
                            <table class="form-table">
                                ...
                                <tr>
                                    <td>Ghi chú</td>
                                    <td>
                                        <textarea name="note" rows="5" class="large-text" id=""><?= $order->note; ?></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div class="submitbox">
                                ...
                                <p>
                                    <input type="submit" name="wp_save_order" id="submit" class="button button-primary" value="Lưu thay đổi">
                                </p>
                            </div>
                        </div>
                    </div>
